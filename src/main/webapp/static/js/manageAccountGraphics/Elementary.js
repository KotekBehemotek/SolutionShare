document.addEventListener("DOMContentLoaded", function () {
    ...
    form.forNumber(function (i) {
        ...
        // verifies if images are in the database

        console.log(xhrStorage.takeFromStorage("imagIsInBase" + i));
    ...
    button.forAll("addListener", "click", function (evt) {
        button.getAway(veryComplicatedExitFunction(evt));
    });
    ...
    function refresh(i) {
        ...
        showPreview();
        // console.log(picturesStates.toString());
